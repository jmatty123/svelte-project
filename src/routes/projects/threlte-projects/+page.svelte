...
<h1 class='m-10 text-center text-2xl font-thin'>Threlte Components</h1>
<h2 class='mx-10 mb-6 text-lg font-thin border-t-[1px] pt-3 border-current'>Threlte is a renderer and component library for Svelte to build and render three.js scenes declaratively and state-driven in Svelte apps. Here you will find some components I've created using various three.js geometry classes with threlte!</h2>
</div>
