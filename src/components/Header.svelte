...
<AppBar gridColumns="grid-cols-3" slotDefault="place-self-center" slotTrail="place-content-end">
    ...
    <svelte:fragment slot="lead">
            <!-- Logo Home Button -->
            <a href="/" class="btn bg-surface-100-800-token text-lg font-semibold pb-3">matthewyoung.
                <div class="flex">
    ...
    <svelte:fragment slot="trail">
        ...
        <button class="md:hidden btn btn-sm bg-surface-100-800-token" on:click={drawerOpen}>
            <span>
